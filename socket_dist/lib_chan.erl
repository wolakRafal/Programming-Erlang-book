...
%%% @doc
%%% Implementation  Based on book "Programing Erlang, 2nd Edition".
%%% Full Documentation flow; you can find it in Appendix 2, A Socket Application, on page 477.
%%% @end
%%% Created : 06. cze 2016 21:07
%%%-------------------------------------------------------------------
-module(lib_chan).
-author(["Joe Armstrong", "Rafal Wolak"]).
...
do_authentication(Pwd, MM, ArgC, MFA) ->
  C = lib_chan_auth:make_challange(),
  send(MM, {challenge, C}),
  receive
    {chan, MM, {response, R}} ->
